...
async function main() {
    try {
        ...
        const caURL = ccp.certificateAuthorities['ca.org0.master.com'].url;
        ...
        console.log('Successfully registered and enrolled admin user' +app_user+ 'and imported it into the wallet');
